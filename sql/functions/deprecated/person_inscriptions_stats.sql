CREATE FUNCTION public.person_inscriptions_stats(
    IN person_id integer,
    OUT "Appearances" bigint,
    OUT "Appearances as Sponsor" bigint,
    OUT "Appearances as Honorand" bigint,
...
$BODY$
SELECT SELECT COUNT(inscription_with_text."ID") AS "Appearances",
       COUNT(CASE
...
FROM (public."Inscription" AS inscription
      ...
      INNER JOIN public."Person in Inscription" AS appearance ON appearance."Inscription ID" = inscription."ID")
